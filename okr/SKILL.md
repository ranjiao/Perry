...
#### `plan-phase <slug>`
Start a new phase. `<slug>` is user-chosen (short, hyphenated). PMO assigns `#<NNN>` automatically: `NNN = (max existing phase number) + 1`, zero-padded to 3 digits. The new file is `phase/<NNN>-<slug>.md` (e.g., `phase/002-cash-deployment.md`).
