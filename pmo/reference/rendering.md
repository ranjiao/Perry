...
├── 2026-05-12-incident-deploy-stuck.html   # rich incident view
└── ...
```
...
│     2026-05-12-incident-deploy-stuck.html               [open →]│
│                                                                 │
...
| Phase | `#002 release-pipeline · day 14 · KRs 2/4 done` | KR progress bars, week-by-week, project list | `→ phase view` |
...
3. **Generate the HTML**:
   - Read the design preset for this view from `.perry/render-presets/<view>.html.j2` if present (template-style preset; see § The "design preset" mechanism). Otherwise, generate from scratch using the prompt convention below.
