...
5. Recommend the order:
   ...
   - Then, run `/perry work` — bootstraps the execution files (`BOARD.md`, `journal/<current-YYYY-MM>/`, `PROJECT_STATE.md`, `evidence/`, `weekly/`, `handoff/`; `decisions/` belongs to the `decide` lane) and runs the first standup.
