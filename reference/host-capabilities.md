...
| Session usage telemetry | none Perry can bind: subagents carry the main session's `CLAUDE_CODE_SESSION_ID`, so `unknown` | none Perry can read: `unknown` | `CODEX_THREAD_ID` names `~/.codex/sessions/*/*/*/rollout-*-<id>.jsonl` |
