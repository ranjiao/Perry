...
- Before starting a Perry phase or integrating product work, read [release rules](release/README.md).
...
Keep this startup protocol under roughly 60 lines; do not duplicate skill or state records.
