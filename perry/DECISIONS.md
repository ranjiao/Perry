...
| [ADR-007](decisions/ADR-007-fields-are-typed-prose-is-not.md) | Python owns typed fields; agents own prose; nothing parses documents | Architecture | 2026-08-19 | **Decided 2026-08-19** — all three rules accepted; first slice is a new phase over BOARD/OKR/config |
