...
| TASK-126 | closing the dangling-id row requires writing the record that re-dangles it | Coding Agent | not_started | spec written; dispatch pre-flight REFUSED on the fragment `diagnose` — awaiting per-task clearance | evidence/2026-08/TASK-126-spec.md | V3 | TASK-112 | main |  |  |  |  |  |  |
