...
| TASK-171 | the events key table is missing three event kinds the live log carries | Coding Agent | not_started | QUEUED behind TASK-168: both live in schema/events-list-contract.md, so it runs after 168 merges | — | V3 | — | main |  |  |
