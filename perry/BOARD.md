...
| TASK-135 | a track can be declared but no existing row can be moved onto it | Coding Agent | in_progress | dispatched to claude-subagent; worktree pinned to 6893da6 | evidence/2026-08/TASK-135-spec.md | V3 | — | main |  |  |  |  |  |  |
