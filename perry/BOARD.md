...
| TASK-165 | an id must dangle once before the report exemption can cover it | Coding Agent | in_progress | CORRECTION to my own diagnosis: TASK-153-result.md:50 is a MENTION, not a definition point. perry-explain USER-900 says 'defined NOWHERE'. The real cause is the inverse — only_an_example reads bool(loc) and is_illustrative(loc), and with loc empty it short-circuits to False meaning 'not an example', so the fallback counted it. An id lifted out of a report has no file for the illustrative rule to judge | — | V4 | — | intake | triaged |  | 2026-08-21 |  |  |  |
| TASK-166 | a closed row whose title was lost is invisible to the check and unreachable by the writer | Coding Agent | in_progress | dispatched 2026-08-27 on coding/task-166-untitled-closed-row | — | V3 | — | intake | triaged |  | 2026-08-21 |  |  |  |
