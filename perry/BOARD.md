...
| TASK-028 | diagnose/adopt mode detection + both READMEs | User + Agent | not_started | rubric written: evidence/2026-08/TASK-028-spec.md. Scoped to diagnose mode detection + both READMEs; the adopt half defers to TASK-044 since ADR-004 rebuilds that pipeline. Rung set V4 per ADR-005. Agent started. | — | V5 |
