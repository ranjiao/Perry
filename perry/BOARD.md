...
| TASK-153 | perry-diagnose counts test fixtures as the project own state, so a fixture USER row makes it disagree with perry-task | Coding Agent | not_started | RELEASED by the user 2026-08-21 for the diagnose fragment, and the design choice came with it: option A, diagnose skips test fixtures. Spec at evidence/2026-08/TASK-153-spec-v2.md; release recorded at evidence/2026-08/TASK-153-dispatch-2026-08-21.md | — | V3 | — | intake | triaged |  | 2026-08-21 |  |  |  |
