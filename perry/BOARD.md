...
| TASK-144 | the event log timestamp has no zone and the register has one, so ordering them is a guess | Coding Agent | in_progress | dispatched 2026-08-28 on coding/task-144-one-clock | — | V3 | — | intake | triaged |  | 2026-08-20 |  |  |  |
...
| TASK-164 | perry-state assigns the state root to a global that means the project root | Coding Agent | in_progress | dispatched 2026-08-28 02:31 on coding/task-164-two-roots-one-global. NOTE: the row was marked in_progress and a slot reserved at 02:11 but THE DISPATCH CALL WAS NEVER MADE — 20 minutes of a phantom in-flight row, caught by comparing the limiter against the live transcripts. Second instance tonight of the limiter reporting bookkeeping as reality; the first was an ESC that killed two agents, this one was me forgetting the call | — | V2 | — | intake | triaged | 2026-08-21 |
