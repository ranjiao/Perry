...
| TASK-140 | every mode contract slot is assigned to an axis, and the spine-to-unit map is written down | Coding Agent | in_progress | dispatched to claude-subagent; worktree pinned to 13cfe2f; escalation on `design/` released by the user 2026-08-20 for this row only | evidence/2026-08/TASK-140-dispatch-2026-08-21.md | V3 | — | main |  |  |  |  |  |  |
