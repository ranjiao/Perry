...
| TASK-158 | the citation families are hardcoded in the tool, so a project with its own id family gets noise on every legitimate citation | Coding Agent | in_progress | — | — | V3 | — | intake | triaged | 2026-08-21 |
