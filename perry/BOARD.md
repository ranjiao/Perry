...
| TASK-171 | the events key table is missing three event kinds the live log carries | Coding Agent | in_progress | first dispatch 2026-08-21 18:07 was killed at 28s by an ESC on the main session — no work written, worktree clean at 923c129. Re-dispatched | — | V3 | — | main |  |  |
