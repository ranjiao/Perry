...
| TASK-038 | tasks: event log becomes canonical, BOARD.md becomes a projection | Coding Agent | not_started | Direction accepted by the user 2026-08-17 (DESIGN-005 § 9): the log becomes canonical, a hand edit raises a reconcile prompt rather than being overwritten or silently trusted. Still sequenced last per § 5.5; the acceptance was taken early so TASK-037's writer is built against the right notion of truth. | — |  |
