...
| TASK-164 | perry-state assigns the state root to a global that means the project root | Coding Agent | in_progress | dispatched 2026-08-28 on coding/task-164-two-roots-one-global | — | V2 | — | intake | triaged | 2026-08-21 |
