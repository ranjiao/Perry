...
All other base paths are unchanged, including TASK-455 product changes and
TASK-456 section splits. Supplied TASK-457 E1 acceptance remains pending.
The supplied base is an isolated accepted batch-2 candidate, not evidence that
main integration or its separately running merged gate has completed.
