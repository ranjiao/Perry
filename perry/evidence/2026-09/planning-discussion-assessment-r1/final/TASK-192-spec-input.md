...
goals/SKILL.md; goals/reference/setup.md; goals/reference/elicitation.md; a narrowly scoped goals reference if needed; existing relevant tests only. Phase-specific procedure edits belong to TASK-194. The 2026-09-17 independent scenario assessment found a conflicting legacy commitment-intake step in goals/reference/phases.md; this task also includes the narrowly bounded Creating one step 3 correction needed to honor already-supplied terms and the shared three-question cap. No other phase scope is added.
