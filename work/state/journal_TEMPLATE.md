...
<!-- Free-form context: what was discussed, what came up, what was deferred.
     Cadence subcommands (monday-plan, midweek-check, friday-review) write their summaries here. -->

## Carry to tomorrow

- (none)

<!-- Things that would otherwise be forgotten when this session ends.
     "Tomorrow morning, check whether USER-027 replied"
     "Coding Agent should land PR before noon" -->
