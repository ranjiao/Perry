...
|---|---|---|---|---|---|
| WIT-001 | The row nobody is holding | Coding Agent | in_progress | finish the rollback path | `README.md`, `linkage.jsonl § the register this project keeps stale` (2 rows), `decisions/` |
...
- **WITNESS-STALE** TOP RISK — every finding here is deliberate; do not fix them.
